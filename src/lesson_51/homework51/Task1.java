...
public class Task1 {
    ...
    private static final String FILE_DATA = "src/lesson_51/homework51/files/data.txt";
    private static final String FILE_LESS = "src/lesson_51/homework51/files/less.txt";
    private static final String FILE_MORE = "src/lesson_51/homework51/files/more.txt";
